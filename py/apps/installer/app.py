...
class Application(QApplication):
  ...
  def systemLocale():
    ...
    # print(script) # PySide2.QtCore.QLocale.Script.AnyScript
    # print(QLocale.SimplifiedChineseScript) # PySide2.QtCore.QLocale.Script.SimplifiedChineseScript
    # if lang == QLocale.Chinese: return 'zh_CN' if script == QLocale.SimplifiedChineseScript else 'zh_TW'
    if lang == QLocale.Taiwan: return 'zh_TW'
    if lang == QLocale.Chinese: return 'zh_CN'
