...
from PySide2.QtCore import Signal, Slot, Property, QObject, QTimer, QThreadPool
...
class SystemStatus(QObject):
  ...
  userPasswordChanged = Signal(str)
  userPassword = Property(str,
