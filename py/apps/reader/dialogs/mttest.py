...
_LEFTARROW = '<span style="color:blue">←</span>'
_RIGHTARROW = '<span style="color:blue">→</span>'
_UPARROW = '<span style="color:blue">↑</span>'
_DOWNARROW = '<span style="color:blue">↓</span>'

_EQ_LABEL = '<span style="color:blue">＝</span>'
_NE_LABEL = '<span style="color:red">≠</span>'
