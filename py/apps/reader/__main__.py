...
def main():
  ...
  print("reader: debug = %s" % debug, file=sys.stderr)
  ...
  for path in config.FONT_LOCATIONS.values():
...
if __name__ == '__main__':
  import sys
  print("reader: enter", file=sys.stderr)
  #print __file__
  import initrc
  initrc.initenv()
  initrc.probemod()
  ...
  ret = main()
  print("reader: leave, ret =", ret, file=sys.stderr)
  sys.exit(ret)
