...
class OcrPopupBean(QObject):
  ...
  popupRequested = Signal(int, int, QObject, QObject, str, str)  # x, y, imgobj, winobj, text, language
...
class GrimoireBean(QObject):
  ...
  clear = Signal()
  pageBreak = Signal()
  showText = Signal(str, str, int)  # text, lang, timestamp
  showTranslation = Signal(str, str, str, QObject, int)  # text, lang, provider, align, timestamp
  showComment = Signal(QObject) # dataman.Comment
  showSubtitle = Signal(QObject) # dataman.SubtitleObject

  showNameText = Signal(str, str)  # text, lang
  showNameTranslation = Signal(str, str, str)  # text, lang, provider
  ...
  @Slot(str, str, bool, int, float, bool, bool, bool, bool, bool, result=str)
  ...
  @Slot(str, int, float, bool, bool, bool, bool, bool, result=str)
  ...
  @Slot(str, bool, str, int, float, bool, bool, bool, result=str)
  ...
  @Slot(str, str, QObject, int, float, bool, bool, result=str)
  ...
  @Slot(str, str, int, str, int, str, int, bool, result=str)
...
class MirageBean(QObject):
  ...
  pageBreak = Signal()
  showText = Signal(str, str, int)  # text, lang, timestamp
  showTranslation = Signal(str, str, str, int)  # text, lang, provider, timestamp
