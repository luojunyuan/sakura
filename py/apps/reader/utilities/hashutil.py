...
if __name__ == '__main__':
  ...
  print(hashcontext("1"))
  print(hashcontext("111222"))
  print(hashcontext("111||222"))
  print(hashtext("111222\n\u3000"))

  print(hashcontext("そして、そこで初めて、オレたちに近づいてくる男の姿を視認する。||「…………」"))
  print(hashcontext("そして||「…………」"))
  print(hashcontext("そして||織「…………」"))
  print(hashcontext('アスタ「なんだ、キノウ姉ちゃんもいたんだ」'))
  print(hashcontext(      '「なんだ、キノウ姉ちゃんもいたんだ」'))
