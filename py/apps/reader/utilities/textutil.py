...
__normalize_name_re = re.compile(r"[【】]")
"""
@param  text  unicode
@return  unicode
"""
...
__capitalize_paragraph_re = re.compile(r"(?:^|(?<=[「」【】]))(\w)", re.UNICODE) # no space
...
__capitalize_html_paragraph_re = re.compile(r"(?:^|(?<=[【】「」]))(\<[^>]+?\>)(\w)", re.UNICODE) # no space
