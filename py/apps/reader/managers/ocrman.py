...
class OcrManager(QObject):
  ...
  imageSelected = Signal(int, int, int, int, QObject, QObject, str, str) # x, y, width, height, OcrImageObject, WindowObject, text, language
  regionSelected = Signal(int, int, int, int) # x, y, width, height, OcrImageObject, WindowObject, text, language
  textRecognized = Signal(str) # text in the selected region is recognized
