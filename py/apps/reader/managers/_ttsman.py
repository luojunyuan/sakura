...
from PySide2.QtCore import QThread, Signal, Qt, QMutex
...
class OnlineThread(QThread):
  playRequested = Signal(object, str, str, str, float) # OnlineEngine, text, language, gender, time
...
ONLINE_ENGINES.extend(iter(VoiceroidOnlineEngine.VOICES.keys()))
ONLINE_ENGINES.extend(iter(VoiceTextOnlineEngine.VOICES.keys()))
