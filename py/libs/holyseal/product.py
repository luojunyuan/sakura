...
class ProductApi(object):
  ...
  def query(self, id):
    ...
    if h:
      ...
      if h and '≫  ≫ </title>' not in h: # empty page
        ret = self._parse(h)
        if ret:
          ret['id'] = int(id)
  ...
  _rx_info_genre = __makeinforx("ジャンル")
  ...
  _rx_info_date = __makeinforx("発売日")
  ...
  _rx_staff = re.compile(r">([^<]*?)</a>")

  _rx_info_artists = __makeinforx("原画")
  ...
  _rx_info_writers = __makeinforx("シナリオ")
