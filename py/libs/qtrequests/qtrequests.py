...
import json, urllib.request, urllib.parse, urllib.error, zlib
from PySide2.QtCore import QUrl, QTimer, QEventLoop, QCoreApplication
...
class _Session:
  ...
  def _encodePostFormData(self, data):
    ...
    """
    data = {self._tostr(k):self._tostr(v) for k,v in data.items()}
