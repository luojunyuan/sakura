...
def ja_ime_location():
  ...
  for ver in range(IME_UPPER_VERSION, IME_LOWER_VERSION -1, -1):
...
if __name__ == '__main__':
  ...
  print("kanji:", to_kanji('すもももももももものうち')) #
  for k,v in to_kanji_list('すもももももももものうち'):
    print(k,v)
  print("kanji:", to_kanji('みじん'*34)) # Only larger than 100

  print("hangul:", to_hangul('計画通'))

  print("hira:", to_hira('計画通り'))
  print("kanji:", to_kanji('けいかくとおり'))
  print(to_kanji('かわいい'))
  # IMJP 14 (windows 7): スモモも桃も桃のうち
  # IMJP 14 (office 2010): すもももももも桃のうち, because there is an anime called すもももももも

  print("roman:", to_roman('計画通り'))
