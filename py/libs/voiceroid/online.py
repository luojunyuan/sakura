...
VOICES = ( # unicode key -> int id
  Voice(1202, 'zunko',  'f', "東北ずん子", "http://www.ah-soft.com/voiceroid/zunko/"),
  #Voice(994, 'zunko',  'f', u"東北ずん子", "http://www.ah-soft.com/voiceroid/zunko/"),
  Voice(1206,   'yukari', 'f', "結月ゆかり", "http://www.ah-soft.com/voiceroid/yukari/"),
  #Voice(2,   'yukari', 'f', u"結月ゆかり", "http://www.ah-soft.com/voiceroid/yukari/"),
  Voice(3,   'maki',    'f', "民安ともえ", "http://www.ah-soft.com/voiceroid/maki/"),
  Voice(1001, 'aoi',    'f', "琴葉 葵",    "http://www.ah-soft.com/voiceroid/kotonoha/"),
  #Voice(992, 'aoi',    'f', u"琴葉 葵",    "http://www.ah-soft.com/voiceroid/kotonoha/"),
  Voice(203, 'akane',   'f', "琴葉 茜",    "http://www.ah-soft.com/voiceroid/kotonoha/"),
  #Voice(999, 'akane',  'f', u"琴葉 茜",    "http://www.ah-soft.com/voiceroid/kotonoha/"),
  Voice(1203, 'ai',     'f', "月読アイ",   "http://www.ah-soft.com/voiceroid/ai/"),
  #Voice(995, 'ai',     'f', u"月読アイ",   "http://www.ah-soft.com/voiceroid/ai/"),
  Voice(1204, 'shota',  'm', "月読ショタ", "http://www.ah-soft.com/voiceroid/shota/"),
  #Voice(996, 'shota',  'm', u"月読ショタ", "http://www.ah-soft.com/voiceroid/shota/"),
  Voice(1207, 'kou',    'm', "水無瀬コウ", "http://www.ah-soft.com/voiceroid/kou/"),
  Voice(1201, 'taka',   'm', "鷹の爪 吉田くん", "http://www.ah-soft.com/voiceroid/taka/"),
...
def createdata(id, text, encoding='utf8', pitch=1, speed=1, gain=None, delay=None):
  ...
  """
  if encoding and isinstance(text, str):
