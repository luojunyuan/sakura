...
class _Engine(object):
  ...
  def registryLocation():
    ...
    import winreg
    try:
      with winreg.ConnectRegistry(None, winreg.HKEY_CURRENT_USER) as reg: # computer_name = None
        with winreg.OpenKey(reg, REG_PATH) as key:
          return winreg.QueryValueEx(key, REG_KEY)[0]
...
if __name__ == '__main__': # DEBUG
  print(location())
  print(len(create_engine().translate("こんにちは")))
