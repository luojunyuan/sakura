...
re_any_anp = re.compile(r"[a-zA-Z0-9%s]" % (s_punct + '.'))
re_all_anp = re.compile(r"^[a-zA-Z0-9%s]+$" % (s_punct + '.'))
re_any_anps = re.compile(r"[a-zA-Z0-9%s]" % (s_punct + '.'))
re_all_anps = re.compile(r"^(?:[a-zA-Z0-9%s]|\s)+$" % (s_punct + '.'))
