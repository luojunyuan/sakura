...
if __name__ == '__main__': # DEBUG
  ...
  ret = Loader().translate("お花の匂い")
  print(ret)

  ret = Loader().translate("せんせい")
  print(ret)
  l = Loader()

  l.setUserDic((
    "../../../../../Dictionaries/jb/@jichi/JcUserdic/Jcuser",
    "../../../../../Dictionaries/jb/@djz020815/JcUserdic/Jcuser",
  ))
  ...
  ret = Loader().translate("脱オタク気分", simplified=True)
  #print ret
