...
VOICES = (
  # ja
  Voice('hikari',    306, 3, 'ja', 'f', "ヒカリ"),
  Voice('sayaka',    304, 3, 'ja', 'f', "サヤカ"),
  Voice('haruka',    303, 3, 'ja', 'f', "ハルカ"),
  Voice('misaki',    302, 3, 'ja', 'f', "ミサカ"),
  Voice('takeru',    307, 3, 'ja', 'm', "タケル"),
  Voice('ryo',       305, 3, 'ja', 'm', "リョウ"),
  Voice('show',      301, 3, 'ja', 'm', "ショウ"),

  # zh-TW
  Voice('hong',      202, 2, 'zh',  'f', "小紅"),
  Voice('qiang',     203, 2, 'zh',  'm', "小强"),

  # ko

  Voice('hyeryun',   10,  0, 'ko',  'f', "혜련"),
  Voice('jihun',     3,   0, 'ko',  'm', "지훈"),

  # en-US
  Voice('julie',     103, 1, 'en',  'f', "Julie"),
  Voice('kate',      100, 1, 'en',  'f', "Kate"),
  Voice('james',     104, 1, 'en',  'm', "James"),
  Voice('paul',      101, 1, 'en',  'm', "Paul"),

  # en
  Voice('bridget',   500, 1, 'en',  'f', "Bridget"),
  Voice('hugh',      501, 2, 'en',  'm', "Hugh"),

  # es
  Voice('violeta',   400, 4, 'es', 'f', "Violeta"),
  Voice('francisco', 401, 4, 'es', 'm', "Francisco"),

  # fr-CA
  Voice('chloe',     600, 4, 'fr', 'f', "Chloé"),
)
