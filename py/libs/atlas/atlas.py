...
class _Engine(object):
  ...
  def registryLocation():
    ...
    import winreg
    try:
      with winreg.ConnectRegistry(None, winreg.HKEY_LOCAL_MACHINE) as reg: # None = computer_name
        with winreg.OpenKey(reg, ATLE_REG_PATH) as key:
          return winreg.QueryValueEx(key, ATLE_REG_KEY)[0]
