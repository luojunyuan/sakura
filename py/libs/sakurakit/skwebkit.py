...
from PySide2.QtCore import Signal, Slot, Qt, Property, QObject, QPoint, QUrl
from PySide2.QtGui import QKeySequence
# from PySide2.QtWebKit import QWebPage, QWebView
from PySide2.QtWebEngineWidgets import QWebEnginePage, QWebEngineView
from PySide2.QtWidgets import QApplication, QPinchGesture, QSwipeGesture
from . import skthreads
...
class SkReadOnlyWebView(QWebEngineView):
...
class SkWebPage(QWebEnginePage): # placeholder
...
class SkWebView(QWebEngineView):
  def __init__(self, parent=None, f=0, page=None): # QWidget, Qt.WindowFlags, QWebPage
    ...
    a = page.action(QWebEnginePage.Forward)
    a.setShortcut(QKeySequence('ctrl+]')) # force CTRL+R on different OSes
    shortcut("ctrl+]", a.trigger, parent=self)
