...
from PySide2.QtCore import Property, Signal, Slot, Qt, QObject, QCoreApplication
# from PySide2.QtQuick import QDeclarativeView
...
class SkDeclarativeView(QQuickView):
  def __init__(self, source, parent=None, imageProviders=[], contextProperties=[]):
    ...
    if root:
      ...
      if var is not None:
        assert isinstance(var, str), "check type"
