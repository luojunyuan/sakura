...
from PySide2.QtCore import Signal, Property, QObject, Qt, QTimer
from . import skevents, skos
from .skclass import Q_Q

if skos.WIN:
  from . import skwin, qtwin
  ...
  class SkWindowObject(QObject):
    ...
    # FIXME: PySide2 handle is not long type! This would crash QML
    winIdChanged = Signal(int)
    winId = Property(int,
  ...
  class SkWindowObject(QObject):
    ...
    winIdChanged = Signal(int)
    winId = Property(int, winId, setWinId, notify=winIdChanged)
    windowClosed = Signal()
    ...
    windowTitle = Property(str, windowTitle)
